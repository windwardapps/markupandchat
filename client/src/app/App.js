...
class App extends Component {
  ...
  render() {
    const { room, shapes, user, users, messages, isEditing, name, color, showPicker, pickerStyle } = this.state;
    return (
      <div className="App flex-col" onClick={this.onClick}>
        <header className="App-header flex-row align-center">
            ...
            <div className="username-wrapper">
              ...
              {isEditing ? (
                <input
                  ...
                  onKeyDown={e => { if (e.keyCode === 13) this.updateUser() }}
            ...
            <div className="color-wrapper flex-row align-center">
              ...
              <Portal isOpened={showPicker}>
                <div style={pickerStyle} onClick={e => e.stopPropagation()}>
                  { showPicker ? (
                    <SketchPicker color={color} onChangeComplete={this.onColorChange} />
                  ) : null }
                </div>
              </Portal>
            </div>
          ...
          <div className="right">
            <button className="done" onClick={this.onDoneClick}>END SESSION</button>
          </div>
        </header>
