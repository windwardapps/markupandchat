...
const Draggable = (getRect, getShape) => (Component) => class Draggable extends React.Component {
  ...
  render() {
    return (
      <Component
        {...this.props}
        renderDragNode={this.renderDragNode}
        setOnDoubleClick={this.setOnDoubleClick} />
    );
  }
